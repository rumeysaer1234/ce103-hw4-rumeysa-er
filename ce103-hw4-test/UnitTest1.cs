...
namespace ce103_hw4_test
{
    ...
    public class UnitTest1
    {
        ...
        public void ce103_fibonacciNumber_test_1()
        {
            ...
            ce103_hw4_cs fibo = new ce103_hw4_cs();
            int expected = fibo.ce103_fibonacciNumber_cs(11);
        ...
        {
            ce103_hw4_cs fibo = new ce103_hw4_cs();
            int result = fibo.ce103_fibonacciNumber_cs(27);

            Assert.AreEqual(result, 196418);
        }
        ...
        {
            ce103_hw4_cs fibo = new ce103_hw4_cs();
            int expected = fibo.ce103_fibonacciNumber_cs(38);

            Assert.AreEqual(expected, 24157817);
        }
        ...
        {
            Class2 fibo = new Class2();
            int expected = fibo.ce103_fibonacciNumber_cs_imported(41);
        ...
        public void Ce103_fibonacciNumber_written_vs_imported_test_1()
        {
            ...
            ce103_hw4_cs writtenFibo = new ce103_hw4_cs();
        ...
        {
            // we're creating object of it otherwise we cannot use ce103_hw4_cs class
           ce103_hw4_cs reverse = new ce103_hw4_cs();

            string original = "Pausebreak";
            string reversed = "kaerbesuaP";
        ...
        public void ce103_strrev_written_test_3()
        {
            ...
            string original = "Printscreen";
            string reversed = "neercstnirP";
        ...
        {
           ce103_hw4_cs strrev = new ce103_hw4_cs();
            Class2 Strrev = new Class2();
        ...
        {
            Class2 strrev = new Class2();
            Assert.AreEqual(strrev.ce103_strrev_cs_imported("Software Engineer"), "reenignE erawtfoS");
        }
        [TestMethod]
        public void ce103_strrev_importedcppcs_test_2()
        {
            ce103_hw4_cs strrev = new ce103_hw4_cs();
            Class2 Strrev = new Class2();
            Assert.AreEqual(strrev.ce103_strrev_cs("Computer Engineer"), "reenignE retupmoC", Strrev.ce103_strrev_cs_imported("Computer Engineer"), "reenignE retupmoC");
        }
        ...
        {
            Class2 strrev = new Class2();
            Assert.AreEqual(strrev.ce103_strrev_cs_imported("Lock"), "kcoL");
        }
        [TestMethod]
        public void ce103_strrev_importedcppcs_test_3()
        {
            ce103_hw4_cs strrev = new ce103_hw4_cs();
            Class2 Strrev = new Class2();
            Assert.AreEqual(strrev.ce103_strrev_cs("RumeysaEr"), "rEasyemuR", Strrev.ce103_strrev_cs_imported("RumeysaEr"), "rEasyemuR");
        }

        [TestMethod]
        public void ce103_strlen_written_test_1()
        {
            ce103_hw4_cs stringLength = new ce103_hw4_cs();
        ...
        public void ce103_strlen_written_vs_imported_test_1()
        {
           ...
           ce103_hw4_cs writtenStrlen = new ce103_hw4_cs();
            string text = "Debug";
        ...
        public void ce103_strcat_cs_import_test_1()
        {
            ...
            Assert.AreEqual(strcat.ce103_strcat_cs_imported("Good", "Day"), "GoodDay");
        }
        [TestMethod]
        public void ce103_strcat_importedcppcs_test_1()
        {
            ce103_hw4_cs strcat = new ce103_hw4_cs();
            Class2 Strcat = new Class2();
            Assert.AreEqual(strcat.ce103_strcat_cs("Hello", "Everyone"), "HelloEveryone", Strcat.ce103_strcat_cs_imported("Hello", "Everyone"), "HelloEveryone");
        }
        ...
        {
            Class2 strcat = new Class2();
            Assert.AreEqual(strcat.ce103_strcat_cs_imported("Cooler", "Boost"), "CoolerBoost");
        }
        [TestMethod]
        public void ce103_strcat_importedcppcs_test_2()
        {
            ce103_hw4_cs strcat = new ce103_hw4_cs();
            Class2 Strcat = new Class2();
            Assert.AreEqual(strcat.ce103_strcat_cs("Thin", "Bezel"), "ThinBezel", Strcat.ce103_strcat_cs_imported("Thin", "Bezel"), "ThinBezel");
        }
        ...
        {
            Class2 strcat = new Class2();
            Assert.AreEqual(strcat.ce103_strcat_cs_imported("Steel", "Series"), "SteelSeries");
        }
        // -----------------------------
        ...
        {
            ce103_hw4_cs strcmp = new ce103_hw4_cs();
        ...
        public void ce103_strcmp_written_vs_imported_test1()
        {
           Class2 importedStrcmp = new Class2();
            ce103_hw4_cs writtenStrcmp = new ce103_hw4_cs();
        ...
        {
            ce103_hw4_cs strcpy = new ce103_hw4_cs();
            string str1 = "Who";
            string str2 = "ami";
        ...
        {
            ce103_hw4_cs hex2bin = new ce103_hw4_cs();
        ...
        public void ce103_hex2bin_written_vs_imported_test1()
        {
            ...
            ce103_hw4_cs written = new ce103_hw4_cs();
        ...
        [TestMethod]
        public void ce103_bin2hex_test1()
        {
            Class2 imported = new Class2();
            byte[] bin = { 0xFA, 0xFA, 0xFA, 0xFA, 0xFA, 0xFA, 0xFA, 0xFA };
            char[] hexstring2 = new char[bin.Length * 2];
        ...
        [TestMethod]
        public void ce103_bin2hex_test2()
        {
            Class2 imported = new Class2();
            byte[] bin = { 0x11, 0x11, 0x11, 0x11, 0x11 };
            char[] hexstring2 = new char[bin.Length * 2];
